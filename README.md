...
![](https://github.com/coolguy0326/data_engineering_projects/blob/master/image.jpeg)

## Project 1: Data Modeling with Postgres
In this project, we apply Data Modeling with Postgres and build an ETL pipeline using Python. A startup wants to analyze the data they've been collecting on songs and user activity on their new music streaming app. Currently, they are collecting data in json format and the analytics team is particularly interested in understanding what songs users are listening to.

Link: [Data_Modeling_with_Postgres](https://github.com/coolguy0326/data_engineering_projects/tree/master/Data_Modeling_with_Postgres)
...
Link : [Data_Modeling_with_Apache_Cassandra](https://github.com/coolguy0326/data_engineering_projects/tree/master/Data_Modeling_with_Apache_Cassandra)
...
Use Redshift IaC script - [Redshift_IaC_README](https://github.com/coolguy0326/data_engineering_projects/blob/master/Redshift_IaC_README.md)

Link  - [Data_Warehouse](https://github.com/coolguy0326/data_engineering_projects/tree/master/Data_Warehouse)
...
Link: [Data_Lake](https://github.com/coolguy0326/data_engineering_projects/tree/master/Data_Lake)
...
Link:  [Airflow_Data_Pipelines](https://github.com/coolguy0326/data_engineering_projects/tree/master/Airflow_Data_Pipelines)
...
Link: [API to Postgres](https://github.com/coolguy0326/data_engineering_projects/tree/master/Data_Api_to_Postgres)
